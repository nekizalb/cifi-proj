...
function GetStaticMatBonus() {
    ...
    const wonderous60 = Math.pow(1.044, Math.max(0, playerData.shardMilestones[25] - 55) * (playerData.shardMilestones[25] > 59))
    staticMatBonus *= wonderous60;
    const wonderous90 = Math.pow(1.068, Math.max(0, playerData.shardMilestones[25] - 84) * (playerData.shardMilestones[25] > 89))
    staticMatBonus *= wonderous90;
    staticMatBonus *= Math.pow(1.018, Math.max(0, playerData.shardMilestones[28] - 20) * (playerData.shardMilestones[28] > 24));
    staticMatBonus *= Math.pow(1.028, Math.max(0, playerData.shardMilestones[28] - 45) * (playerData.shardMilestones[28] > 49));
